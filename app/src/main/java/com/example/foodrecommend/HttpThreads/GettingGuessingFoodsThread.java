...
public class GettingGuessingFoodsThread extends Thread {

    Handler handler;
    String username;

    public GettingGuessingFoodsThread(Handler handler, String username) {
    ...
    public void run() {
        ...
        try {
            ...
            String outputData = "function=" + "gettingGuessingFoods&username=" + username;
...
//            connection.setReadTimeout(20000);
            ...
            for (int i = 0; i < jsonObject.length(); i++) {
                ...
                RecommendFragment.guessingFoodList.add(new Food(id, name, picUrl));
            }
